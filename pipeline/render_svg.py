...
def _make_settings(text_to_path: bool, logger: logging.Logger) -> Settings:
    ...
    try:
        ...
        return Settings(text_policy=TextPolicy.FILLING)  # pragma: no cover
...
def _render_one(dxf_path: str, svg_out: str, theme_cfg: ThemeConfig | None,
                text_to_path: bool, logger: logging.Logger) -> None:
